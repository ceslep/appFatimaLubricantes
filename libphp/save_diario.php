...
try {
    ...
    $worksheetTitle = $data['worksheetTitle'] ?? 'diario';
    $range = $worksheetTitle . '!A1:Z5000';

    // Inicializar cliente de Google
    $client = new Client();
    $client->setApplicationName('Diario de Campo');
    ...
    $expectedFields = 7; // timestamp, fecha, docente, asignatura, grado, horas, anotacion, observacion
